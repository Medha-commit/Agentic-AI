...
Your entire response should be a single line starting with either FUNCTION_CALL: or FINAL_ANSWER:"""
                ...
                while iteration < max_iterations:
                    ...
                    if response_text.startswith("FUNCTION_CALL:"):
                        ...
                        For each step, use EXACTLY one of these commands:
                        PAINT_OP: open_paint
                        PAINT_OP: draw_rectangle|780|380|1140|700
                        PAINT_OP: add_text_in_paint|{math_result}

                        Important: Give only ONE command at a time. Wait for each operation to complete before proceeding to the next."""
